...
Scenario: Search with Radius set to Zero
	...
	And click search
	Then I should be on the "/ImHungry/IHSearch?search_query=chicken&num_results=2&radius=0&username=" page
...
Scenario: Search with Negative Radius
	...
	And click search
	Then I should be on the "/ImHungry/IHSearch?search_query=tacos&num_results=3&radius=5&username=" page

Scenario: Search with No Radius
	When I type "tacos" into the search bar
	And I type "3" into the number bar
	And click search
	Then I should be on the "/ImHungry/IHSearch?search_query=tacos&num_results=3&radius=&username=" page
...
Scenario: Results page only displays restaurants within the given radius
	...
	And click search
	Then I should be on the "/ImHungry/IHSearch?search_query=tacos&num_results=4&radius=1&username=" page
